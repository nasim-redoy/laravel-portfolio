...
<section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
        <h1>Alex Smith</h1>
        <p>I'm <span class="typed" data-typed-items="Designer,Developer,Freelancer,Photographer,Laravel"></span></p>
    </div>
</section><!-- End Hero -->
        ...
        <div class="container">
            ...
            <div class="row skills-content">
                ...
                <div class="col-lg-6" data-aos="fade-up">
                    ...
                    @foreach($firstGroupSkills as $skill)
                        <div class="progress">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                    ...
                    @foreach($secondGroupSkills as $skill)
                        <div class="progress">
                            <span class="skill">{{$skill->name}} <i class="val">{{$skill->percentage}}%</i></span>
                            <div class="progress-bar-wrap">
                                <div class="progress-bar" role="progressbar" aria-valuenow="{{$skill->percentage}}" aria-valuemin="0" aria-valuemax="100"></div>
